...
阵列轴的选择：
通常选择圆柱面或者圆弧边线，完整或者部分均可

**勾选变化的实例**，可以修改实例之间的变化量，如每次增大几度，每个实例的尺寸依次增大多少

![](assets/README-2025-08-05-08-36-23.png)

#### 曲线驱动的阵列

沿着一条线（线性或非线性）阵列特征、面、实体，这条线可以是草图线也可以是实体边线还可以是三维曲线。

**对齐方法**
**与曲线相切**：源对象相对于该点处曲线的切线方向有一个姿态，阵列出来的图形与其对应点处曲线的切线方向也保持该姿态。
**对齐到源**：阵列出来的图形的姿态与源对象相同。

**曲线方法**
**转换曲线**：从所选曲线原点（并非曲线端点，而是与源对象位置有关）到源对象的 Delta X 和 Delta Y 的距离均赋予每个实例。
**等距曲线**：从源对象到所选曲线的垂直距离均赋予每个实例。

**面法线**：针对与 3D 曲线，选取 3D 曲线所处的面来生成曲线驱动的阵列。
注意当对齐方式选择与曲线相切时才能激活该选项。

**注意**：曲线驱动阵列里面的距离指的是曲线的长度，而不是直线距离。
